...
;;; Commentary:
;;; vim-default theme created by  in 2023

;;; Code:

(deftheme vim-default)
...
;;      (str     "#ff55ff")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,black :background ,white))))
   `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,black :background ,fg6 :weight normal))))
   `(mode-line-buffer-id ((,class (:bold t :foreground ,bg1 :background ,unspec))))
	 `(mode-line-highlight ((,class (:foreground ,bg1 :box nil :weight bold))))
...
(provide-theme 'vim-default)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; vim-default-theme.el ends here
