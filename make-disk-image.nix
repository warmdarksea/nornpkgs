...
*/
{
  ...
  rootGPUID ? "00000000-0000-0000-0000-000000000000",
  ...
  partitionDiskScript =
    {
      ...
      "legacy+gpt" = ''
        ...
        ${lib.optionalString deterministic ''
          ...
          --partition-guid=1:00000000-0000-0000-0000-000000000000 \
          --partition-guid=2:00000000-0000-0000-0000-000000000000 \
