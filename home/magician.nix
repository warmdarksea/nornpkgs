{ lib, pkgs, nixpak, ... }: let
  ...
  # retired nornpkgs package repo (this repo inherited the name), which is
  # no longer an input. re-wire the bitwig sandbox via
  # home/nixpak/bitwig.nix + the nixpak input when needed.
